...
/**
 * Servicio de API simulando para pruebas locales
 *
...
object MockApiService {
     ...
     * Email: marlon@gmail.com | Password: 123456
     * Email: marlonino@gmail.com | Password: 123456
     */
    suspend fun login(loginRequest: LoginRequest): Response<LoginResponse> {
        //Simulamos la latencia de red (1-2 segundos)
        delay((1000..2000).random().toLong())
        //Validanciones básicas
    ...
    /**
     * Simula la validación de un token
     */
