package mx.edu.utng.mrg.security01.ui.screens
...
import mx.edu.utng.mrg.security01.R
import mx.edu.utng.mrg.security01.models.AuthState
import mx.edu.utng.mrg.security01.ui.components.CustomTextField
import mx.edu.utng.mrg.security01.ui.components.ErrorDialog
import mx.edu.utng.mrg.security01.ui.components.LoadingButton
 ...
 * -Estados = Los dialogos que van cambiando
...
fun LoginScreen(
     ...
     * a cambios especificos y reacciona cuando ocurren
     */
    ...
    Box(
        ...
        Column(
            ...
            //=======================================
            TextButton(
                onClick = {/*TODO: Navegar a recuperar la contraseña*/},
                enabled = authState !is AuthState.Loading
            ) {
                Text(
